...
export function CookieConsentModal({ locale }: CookieConsentModalProps) {
  ...
  if (view === "main") {
    return (
      ...
      >
        <div className="relative rounded-[28px] sm:rounded-[32px] border border-[var(--color-border-subtle)] bg-[var(--color-surface-base)]/98 backdrop-blur-2xl px-6 pb-6 pt-8 shadow-2xl shadow-black/30 dark:shadow-black/80">
          {/* Top Center Circular Cookie Badge (Straddling the top border exactly like the reference image) */}
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs sm:text-[13px] leading-relaxed text-[var(--color-text-secondary)] font-normal text-left sm:text-center">
              {isTr ? (
                <>
            ...
            {/* 3 Horizontal Action Buttons Row: No text wrapping */}
            <div className="grid grid-cols-3 gap-2 sm:gap-2.5 pt-1">
              <button
                type="button"
                onClick={handleOnlyEssential}
                className="whitespace-nowrap px-2.5 sm:px-3 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl border border-[var(--color-border-subtle)] bg-[var(--color-surface-hover)] hover:bg-[var(--color-surface-active)] text-xs sm:text-[13px] font-semibold text-[var(--color-text-primary)] transition-all shadow-sm active:scale-[0.98] text-center cursor-pointer"
              >
              ...
              <button
                ...
                className="whitespace-nowrap px-2.5 sm:px-3 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-xs sm:text-[13px] shadow-lg shadow-blue-500/25 transition-all active:scale-[0.98] text-center cursor-pointer"
              >
