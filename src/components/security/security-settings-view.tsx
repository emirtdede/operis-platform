...
export function SecuritySettingsView({ locale, twoFactorEnabled }: SecuritySettingsViewProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-[var(--color-border-subtle)] bg-[var(--color-surface-base)] backdrop-blur-xl p-6 sm:p-7 space-y-4 shadow-sm">
      ...
      {isBackupCodesModalOpen && (
        ...
        >
          <div className="relative w-full max-w-lg rounded-2xl border border-emerald-500/30 bg-[var(--color-surface-base)] p-6 shadow-2xl space-y-5">
            <div className="flex items-center justify-between border-b border-[var(--color-border-subtle)] pb-4">
            ...
            <div className="grid grid-cols-2 gap-2 p-3 bg-slate-950/80 rounded-xl border border-slate-800">
            ...
            {/* Action Buttons */}
            <div className="pt-2 flex flex-wrap items-center justify-between gap-2.5 border-t border-[var(--color-border-subtle)]">
              <div className="flex items-center gap-2">
                <Button
                  type="button"
                  variant="secondary"
