...
export function DraftRecoveryBar({
  ...
  return (
    <div
      ...
      className="rounded-2xl border border-blue-500/30 bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-blue-500/5 p-4 sm:p-5 shadow-lg backdrop-blur-md transition-all duration-300 animate-in fade-in slide-in-from-top-2"
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1 sm:pt-0">
          <Button
            ...
            size="sm"
            onClick={onRestore}
            className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-500 text-white font-medium text-xs shadow-sm"
          >
          ...
          <Button
            ...
            size="sm"
            onClick={onDiscard}
            className="flex items-center gap-1.5 text-xs text-[var(--color-text-secondary)] hover:text-red-400 hover:border-red-500/30"
          >
          ...
          <button
            ...
            className="ml-1 p-1.5 rounded-lg text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)] hover:bg-[var(--bg-elevated)] transition-colors"
          >
